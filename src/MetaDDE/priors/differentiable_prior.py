...
def get_batch(batch_size, seq_len, num_features, get_batch
    ...
    # print('num_models', num_models) num_models=1
    ...
    # print('sample', sample[0][3])   #sample[0] 长度为4的tuple = (x, y, y_, hyperparameter_dict)
    # print('yyy', sample[0][1]) ##target y (y_)都有问题， 全是-100，这个分布不适合生成regression？
