...
def get_stats_arg_parser():
    ...
    parser.add_argument('--attn_head_key_dim', type=int, default=511, help='') #511
    parser.add_argument('--feed_forward_dim', type=int, default=2048, help='')
    parser.add_argument('--num_self_attn_layers', type=int, default=4, help='')   ## 6
    parser.add_argument('--num_cross_attn_layers', type=int, default=4, help='')  ## 6 
    ...
    parser.add_argument('--min_n_epochs', type=int, default=1, help='Minimum number of epochs.') #3
    ...
    parser.add_argument('--ckpt_dirname', type=str, default='ckpt/{0:s}_{1:s}',
                        help='')
    parser.add_argument('--tfm_train', type=int, default=0,
                        help='') 
